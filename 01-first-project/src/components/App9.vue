  ...
  <div class="w-[95%] mx-auto flex justify-center items-center">
    <section class="flex flex-col items-center">
      ...
      <div class="space-y-3 mb-5">
        <div class="space-x-5">
          <button class="btn w-20" @click="onIncrementCounter">+1</button>
          <button class="btn w-20" @click="onResetCounter">Reset</button>
          <button class="btn w-20" @click="onDecrementCounter">-1</button>
        </div>
        <button
          :disabled="isNumberAlreadyStored"
          :class="['btn', 'w-full', { 'btn-disabled': isNumberAlreadyStored }]"
      ...
      <div>
        ...
        <ul class="flex gap-3 justify-center">
          <li v-for="num in favoriteNumbers" :key="num">
